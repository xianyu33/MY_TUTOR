-- Junior High School Mathematics Knowledge Points Data Insertion Script
-- Grade 7 to Grade 9 (Junior High School) Mathematics Knowledge Points
-- Note: Make sure to run knowledge_category_data.sql first to insert the required categories

-- Ensure knowledge categories exist before inserting knowledge points
-- The following categories should exist:
-- 1. Number and Algebra (NUMBER_ALGEBRA)
-- 2. Geometry (GEOMETRY) 
-- 3. Statistics and Probability (STATISTICS_PROBABILITY)
-- 4. Comprehensive Application (COMPREHENSIVE)
